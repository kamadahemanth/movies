...
app.post("/movies/", async (request, response) => {
  ...
  const addMovieQuery = `INSERT INTO movie (director_Id, movieName, lead_Actor) VALUES (${directorId}, '${movieName}','${leadActor}');`;
...
app.get("/directors/:directorId/movies", async (request, response) => {
  ...
  const getDirectorMovieQuery = `SELECT movie_name FROM director INNER JOIN movie ON director.director_id = ${directorId};`;
